...
The autonomous humanoid system represents the culmination of embodied intelligence concepts from all previous modules. This chapter builds on the ROS 2 architecture from [Module 2](../module-02-ros2/architecture-setup), the simulation fundamentals from [Module 3](../module-03-sim-fundamentals/robot-description-models), the NVIDIA Isaac platform concepts from [Module 5](../module-05-isaac-ai-brain/isaac-architecture), the Vision-Language-Action systems from [Module 6](../module-06-vla-systems/vla-foundations), and the humanoid systems from [Module 7](../module-07-humanoid-hri/kinematics-dynamics). This chapter establishes the architectural foundation that enables all subsequent components to work together safely and effectively. You'll understand how to design systems with proper separation of concerns while maintaining the ability to handle complex, real-world scenarios.
